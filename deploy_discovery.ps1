# deploy_discovery.ps1
# Deploys the discovery Lambda function to AWS
# Run from the project root: .\deploy_discovery.ps1

$ErrorActionPreference = "Stop"

$FUNCTION_NAME = "aws-docs-rag-discovery"
$PROFILE       = "aws-docs-rag-dev"
$REGION        = "us-east-1"
$SOURCE_DIR    = "backend\discovery"
$ZIP_FILE      = "discovery_function.zip"
